...
public class SolidWallSide1 : SolidWall_1 {
	...
	void OnTriggerExit(Collider collider){
		...
		if (collider.tag == "CorridorBox" && inWall == true
			...
			hmd_user.GetComponent<SolidWallFront1>().ShowOutOfBoundsObjects(true);
			hmd_user.GetComponent<HMD_user> ().trespassed (true);
